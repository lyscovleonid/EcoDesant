...
| Библиотека | Правообладатель | Лицензия |
|------------|-----------------|----------|
| **React** | Meta Platforms, Inc. | MIT |
| **VKUI** | VK (ООО «В Контакте») | MIT |
| **@vkontakte/vk-bridge** | VK | MIT |
| **@vkontakte/vk-mini-apps-router** | VK | MIT |
| **axios** | Matt Zabriskie | MIT |
| **react-qr-code** | Ross Khanas | MIT |
| **@pbe/react-yandex-maps** | PBE | MIT |
...
| **better-sqlite3** | Joshua Wise | MIT |
| **SQLite** (через better-sqlite3) | D. Richard Hipp (общественное достояние) | Public Domain |
| **cors** | Troy Goode | MIT |
| **json2csv** | Mirco Zeiss | MIT |
| **exceljs** | Guyon Roche | MIT |
| **TypeScript** | Microsoft | Apache 2.0 |
| **ts-node** | TypeStrong | MIT |

### Чат-бот

| Библиотека | Правообладатель | Лицензия |
|------------|-----------------|----------|
| **@maxhub/max-bot-api** | MAX (ООО «МАКС») | MIT |
| **dotenv** | Scott Motte | BSD-2-Clause |
| **Node.js (http)** | OpenJS Foundation | MIT |

> Все перечисленные библиотеки разрешают коммерческое и некоммерческое использование, модификацию и распространение при сохранении уведомления об авторских правах. Исходный код проекта «ЭкоДесант» распространяется под лицензией MIT, если не указано иное. Товарные знаки VK, MAX, Meta, Microsoft и др. принадлежат соответствующим правообладателям и не передаются по лицензии.
